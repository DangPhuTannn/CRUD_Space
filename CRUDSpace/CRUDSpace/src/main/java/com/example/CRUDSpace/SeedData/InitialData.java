...
//  * 2. Seed Space : Block/Floor/Room theo mẫu
//  * 3. Tạo Inventory : Một Inventory dưới mỗi Block
//  * 4. Seed Equipment : “Máy lạnh”, “Máy chiếu”, “Bàn ghế” cho mọi Room &
//  * Inventory
//  */
// @Configuration
...
//     /* Struc tạm giữ dữ liệu Space mẫu */
...
//         /* ===== 2. Seed Block/Floor/Room ===== */
//         if (spaceRepo.count() == 0) { // chỉ seed khi bảng rỗng
...
//         /* ===== 3. Tạo Inventory dưới mỗi Block ===== */
...
//         /* ===== 4. Seed Equipment cho Room & Inventory ===== */
//         List<Space> targets = spaceRepo
...
//         if (equipRepo.countBySpace(space) > 0)
//             return; // đã seed thiết bị cho Space này

//         List<String> items = List.of("Máy lạnh", "Máy chiếu", "Bàn ghế");
//         items.forEach(item -> equipRepo.save(Equipment.builder()
//                 .equipmentName(item) // không unique
//                 .space(space)
//                 .build()));
//         log.info("Seeded 3 equipments for {}", space.getSpaceName());
//     }
// }